  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-1000 bg-background/80 backdrop-blur-md border-b border-border overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
        <img src={fullLogo} alt="Roncoin Logo" className="w-[30vw] max-w-[10rem]" onClick={() => navigate('/')}/>
        <div className="sections flex items-center gap-4">
          <p className='cursor-pointer' onClick={() => navigate('/whitepaper')}>Whitepaper</p>
          <p className='cursor-pointer' onClick={() => navigate('/about')}>About</p>
          <p className='cursor-pointer' onClick={() => navigate('/transparency')}>Transparency</p>
          <p className='cursor-pointer' onClick={() => navigate('/bridge')}>Bridge</p>
        </div>
